...
class ArticleResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        $array = [
            ...
            'banner_file_url'   => !empty($this->documents) && isset($this->documents[0]) && isset($this->documents[0]['file_url']) ? asset('/public/' . $this->documents[0]['file_url']) : null,
            'thumbnail_file_url'=> !empty($this->documents) && isset($this->documents[1]) && isset($this->documents[1]['file_url']) ? asset('/public/' . $this->documents[1]['file_url']) : null,
