        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                if ($request->hasFile('video')) {
                    ...
                    $insertData->video_link = $directory.$fileName; // if enable VideoProcess, then comments this line
                    $insertData->video_code = 'Completed'; // if enable VideoProcess, then comments this line
